...
\section{Expérience}
\cventry{2018, 10 semaines}{Stage de fin de DUT — recherche universitaire}{Université de Plymouth (UK)}{Recherche d’algorithme d’aggrégation de textes par sujet, utilisant Twitter}{Plymouth, Royaume Uni}{}
